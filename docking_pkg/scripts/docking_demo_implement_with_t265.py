    ...
    def demo_callback(self, timer):
        ...
        if len(self.apriltag_msg.detections) == 3:
            ...
            try: # use try to prevent loss data on current time
                ...
                tf_odom_to_tag24 = self.tfBuffer.lookup_transform('camera_link', 'tag_24', rospy.Time()) #left
                tf_odom_to_tag25 = self.tfBuffer.lookup_transform('camera_link', 'tag_25', rospy.Time()) #middle
                tf_odom_to_tag26 = self.tfBuffer.lookup_transform('camera_link', 'tag_26', rospy.Time()) #right
                ...
                try:
                    ...
                    tf_base_footprint_to_tag25 = self.tfBuffer.lookup_transform('camera_link', 'tag_25', rospy.Time()) #middle
                except:
                    pass
                else:
                ...
                if self.tf_robot_to_tag25.transform.translation.x > 1.0:
                    ...
                    xx = 0.0 + self.tf_robot_to_tag25.transform.translation.x - 0.9 # next point = 0.9 m from station
                else:
                    # palabola equation
                ...
                tf_docking.header.frame_id = 'camera_link'
